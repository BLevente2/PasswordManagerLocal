...
public sealed class GetSynchronizationStatusWindowsIpcRequestHandler : IWindowsIpcRequestHandler
{
    ...
    public GetSynchronizationStatusWindowsIpcRequestHandler(
    ...
    public IpcOperationId OperationId => IpcOperationId.GetSynchronizationStatus;
        ...
        CancellationToken cancellationToken)
    {
        ...
        var status = await _statusProvider.GetSynchronizationStatusAsync(cancellationToken);
        _contractValidator.Validate(status);
        return context.Success(status, WindowsIpcJsonContext.Default.SynchronizationStatusDto);
    }
}
