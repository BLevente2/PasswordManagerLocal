...
$requiredPhaseReports = @(
    ...
    'WINDOWS_UI_AGENT_LIFECYCLE_BUILD_FIX_STATIC_VERIFICATION.md',
    'PHASE10_1_ANDROID_ATTACHMENT_AUTHORITY_TEARDOWN_STATIC_VERIFICATION.md',
    'PHASE10_1_IMPLEMENTATION_CHECKS.md',
    'PHASE10_1_MODIFIED_FILES.md',
