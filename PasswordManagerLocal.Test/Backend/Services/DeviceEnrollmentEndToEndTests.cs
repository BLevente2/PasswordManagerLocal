...
public sealed class DeviceEnrollmentEndToEndTests
{
    ...
    public async Task FullEnrollmentBetweenTwoProductionBackends_TransfersProfileAndAllowsLogin()
    {
        ...
        Assert.IsInstanceOfType<PasswordManagerLocal.Backend.Services.SyncVersionClockService>(
            source.Services.GetRequiredService<PasswordManagerLocal.Backend.Abstractions.Services.ISyncVersionClockService>());
