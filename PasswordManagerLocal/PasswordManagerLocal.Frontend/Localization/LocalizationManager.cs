...
namespace PasswordManagerLocal.Frontend.Localization;
...
public static class LocalizationManager
{
    ...
    private static Dictionary<string, string>? LoadLanguage(AppLanguage language)
    {
        try
        {
            ...
            {
                AppLanguage.Hungarian => "avares://PasswordManagerLocal.Frontend/Assets/Localization/hu.json",
                _ => "avares://PasswordManagerLocal.Frontend/Assets/Localization/en_us.json"
            });
